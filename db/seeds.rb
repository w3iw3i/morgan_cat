...
Asset.create(asset_type: "stocks", amount: 10000, growth_rate: 8, user_id:2, asset_allocation: 10)
Asset.create(asset_type: "bonds", amount: 2000, growth_rate: 2, user_id:2, asset_allocation: 10)
Asset.create(asset_type: "cpfo", amount: 2000, growth_rate: 4, user_id:2, asset_allocation: 15)
Asset.create(asset_type: "cpfs", amount: 1000, growth_rate: 4, user_id:2, asset_allocation: 3)
Asset.create(asset_type: "cpfm", amount: 1000, growth_rate: 4, user_id:2, asset_allocation: 2)
