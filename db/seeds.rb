...
Asset.create(asset_type: "stocks", amount: 10000, growth_rate: 8, user_id:1, asset_allocation: 30)
Asset.create(asset_type: "bonds", amount: 2000, growth_rate: 2, user_id:1, asset_allocation: 20)
